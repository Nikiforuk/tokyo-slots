...
export default function CoinButton({icon, iconWidth, iconHeight, position, top,  left, right, bottom, reverse}: CoinButtonProps) {
  ...
  return (
    ...
    >
      ...
      <Image className={styles.secondIcon} style={reverse ? { transform: 'scaleX(-1)' } : undefined} src={icon} width={iconWidth} height={iconHeight} alt='arrow' />
    </motion.button>
  )
}
